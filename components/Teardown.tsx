  ...
  return (
    <section id="teardown" className="relative py-28 md:py-36">
      <div className="shell">
        ...
        <Reveal delay={0.1}>
          <div className="mt-14 grid gap-px overflow-hidden rounded-2xl border border-hair bg-hair lg:grid-cols-[0.85fr_1.15fr]">
            {/* Inputs */}
            ...
            <div className="bg-pitch p-8 md:p-10">
              ...
              {/* The verdict */}
              <div className="mt-10 rounded-xl border border-signal/25 bg-signal/[0.05] p-6">
                {r.hasGap ? (
                  <>
